        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://wa.me/916382513075" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-green-500 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Home', 'About Us', 'Vehicles', 'Packages', 'Contact Us'].map((link) => (
                <li key={link}>
                  <a href="#" className="text-sm hover:text-yellow-500 transition-colors">{t(link)}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-sm hover:text-yellow-500 transition-colors">{t('Local Tour')}</a></li>
              <li><a href="#" className="text-sm hover:text-yellow-500 transition-colors">{t('Outstation Tour')}</a></li>
              <li><a href="#" className="text-sm hover:text-yellow-500 transition-colors">{t('Airport Transfer')}</a></li>
              <li><a href="#" className="text-sm hover:text-yellow-500 transition-colors">{t('Temple Tour')}</a></li>
              <li><a href="#" className="text-sm hover:text-yellow-500 transition-colors">{t('Corporate Travel')}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm">+91 63825 13075</span>
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm">Housing Board, Mela Anuppanadi, Madurai - 625009, Tamil Nadu, India.</span>
              </li>
            </ul>
          </div>
